...
redThermometer = {0x28, 0xD4, 0xAD, 0x91, 0xB0, 0x24, 0x06, 0x2C};

blueThermometer = {0x28, 0x67, 0x03, 0x5E, 0x9B, 0x23, 0x09, 0x3A};
redThermometer = {0x28, 0x82, 0xB8, 0x46, 0xA1, 0x23, 0x06, 0x16};
blueThermometer = {0x28, 0x1B, 0xDC, 0x17, 0xB0, 0x24, 0x06, 0xE7};
blueThermometer = {0x28, 0x01, 0x22, 0x1D, 0xB0, 0x24, 0x06, 0x6C};
redThermometer = {0x28, 0xCB, 0xC9, 0x69, 0xB0, 0x24, 0x06, 0x30};

blueThermometer = {0x28, 0xAA, 0x2B, 0x56, 0xA1, 0x23, 0x06, 0xC0};
redThermometer = {0x28, 0xCE, 0x8D, 0x77, 0x9B, 0x23, 0x09, 0x7A};
blueThermometer = {0x28, 0x71, 0x96, 0xCA,
                                 0xA1, 0x23, 0x08, 0xB3};
redThermometer = {0x28, 0x65, 0x4B, 0x15, 0xB0, 0x24, 0x06, 0x8D};

redThermometer = {0x28, 0x76, 0x76, 0x77, 0xA1, 0x23, 0x07, 0xA1};
blueThermometer = {0x28, 0xA9, 0x68, 0x74,
                                 0xB0, 0x24, 0x06, 0xC6};
blueThermometer = {
    0x28, 0xEC, 0xC4, 0x2A, 0xB0, 0x24, 0x06, 0x87,
};
redThermometer = {0x28, 0x4A, 0xE9, 0xC8, 0xA1, 0x23, 0x08, 0xA3};

*/
DeviceAddress redThermometer = {0x28, 0xC6, 0xCB, 0xB8, 0xA1, 0x23, 0x08, 0xE7};
DeviceAddress blueThermometer = {0x28, 0x83, 0x3E, 0x4B,
                                 0xA1, 0x23, 0x06, 0xEB};
