...
c.NotebookApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$1jasonntHGljG/u/y38W/g$T3D6bBd+/0PluY4RXvj91Q"
...
#  Choices: any of ['sha3_224', 'sha384', 'sha3_256', 'blake2b', 'sha512', 'sha3_512', 'sha3_384', 'sha224', 'sha256', 'md5', 'blake2s', 'sha1']
#  Default: 'sha256'
